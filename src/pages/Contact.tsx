    ...
    <div className="bg-bg-light min-h-screen py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-charcoal mb-4 font-urdu">Contact Us</h1>
          <p className="text-lg text-gray-600 font-urdu max-w-2xl mx-auto">
            Humein apne sujhau (suggestions), corrections, ya technical issues ke baray mein aagah karein.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-primary/5 p-6 rounded-2xl border border-primary/10">
              <h3 className="font-bold text-primary mb-2 font-urdu">Ask a Fatwa?</h3>
              <p className="text-sm text-gray-700 font-urdu mb-4">
                Agar aapko Shar‘i masla poochna hai toh baraye meharbani 'Ask a Question' page use karein.
              </p>
              <a href="/ask" className="text-sm font-bold text-primary hover:underline">
                Go to Ask a Question &rarr;
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            {isSubmitted ? (
              <div className="bg-white p-10 rounded-3xl border border-gray-100 shadow-sm text-center h-full flex flex-col justify-center items-center">
                ...
                <h3 className="text-2xl font-bold text-charcoal mb-2 font-urdu">Message Sent</h3>
                <p className="text-gray-600 font-urdu">Aapka paigham humein mil gaya hai. Hum jald az jald aapse rabta karne ki koshish karenge.</p>
              </div>
            ) : (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="source">Source Request</option>
                        <option value="technical">Technical Issue</option>
                        <option value="scholar">Scholar Review Application</option>
